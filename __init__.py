...
def get_Winter_Olympics_schedule(date_text):
    ...
    with open(Winter_Olympics_schedule_name, 'r', encoding='utf-8') as fo:
        ...
        if schedule_Data[0][date_text]:
            ...
            # 设置所使用的字体
            date_font = ImageFont.truetype("./plugins/bot_2022_Winter_Olympics/font/DroidSansFallback.ttf",
                                           17)  # 日期字体：方正粗圆宋简体，19
...
def receive_group_msg(ctx: GroupMsg):
    if (ctx.Content == "冬奥会日程表"):
        ...
        medal_text = "〖NO.1〗" + get_emoji(medal_data["data"]["list"][0]["nocName"]) + medal_data["data"]["list"][0][
            "nocName"] + " 共: " + medal_data["data"]["list"][0]["total"] + " 枚\n🥇 " + medal_data["data"]["list"][0][
                         "gold"] + "  🥈 " + medal_data["data"]["list"][0]["silver"] + "  🏅 " + \
                     medal_data["data"]["list"][0]["bronze"] + "\n" + "〖NO.2〗" + get_emoji(
            medal_data["data"]["list"][1]["nocName"]) + medal_data["data"]["list"][1]["nocName"] + " 共: " + \
                     medal_data["data"]["list"][1]["total"] + " 枚\n🥇 " + medal_data["data"]["list"][1][
                         "gold"] + "  🥈 " + medal_data["data"]["list"][1]["silver"] + "  🏅 " + \
                     medal_data["data"]["list"][1]["bronze"] + "\n" + "〖NO.3〗" + get_emoji(
            medal_data["data"]["list"][2]["nocName"]) + medal_data["data"]["list"][2]["nocName"] + " 共: " + \
                     medal_data["data"]["list"][2]["total"] + " 枚\n🥇 " + medal_data["data"]["list"][2][
                         "gold"] + "  🥈 " + medal_data["data"]["list"][2]["silver"] + "  🏅 " + \
                     medal_data["data"]["list"][2]["bronze"] + "\n" + "〖NO.4〗" + get_emoji(
            medal_data["data"]["list"][3]["nocName"]) + medal_data["data"]["list"][3]["nocName"] + " 共: " + \
                     medal_data["data"]["list"][3]["total"] + " 枚\n🥇 " + medal_data["data"]["list"][3][
                         "gold"] + "  🥈 " + medal_data["data"]["list"][3]["silver"] + "  🏅 " + \
                     medal_data["data"]["list"][3]["bronze"] + "\n" + "〖NO.5〗" + get_emoji(
            medal_data["data"]["list"][4]["nocName"]) + medal_data["data"]["list"][4]["nocName"] + " 共: " + \
                     medal_data["data"]["list"][4]["total"] + " 枚\n🥇 " + medal_data["data"]["list"][4][
                         "gold"] + "  🥈 " + medal_data["data"]["list"][4]["silver"] + "  🏅 " + \
                     medal_data["data"]["list"][4]["bronze"]
        Text(medal_text)
